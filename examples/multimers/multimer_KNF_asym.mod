...
# * an asymmetric model for subunit interactions
...
Structure: {
	...
	add_allosteric_couplings => [
		[0, 1, Gamma_S01, Phi_TR],
		[0, 2, Gamma_S02, Phi_TR],
		[0, 3, Gamma_S03, Phi_TR],
		[1, 2, Gamma_S12, Phi_TR],
		[1, 3, Gamma_S13, Phi_TR],
		[2, 3, Gamma_S23, Phi_TR],
	],
}
